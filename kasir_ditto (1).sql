...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2019 at 04:40 PM
...
--
DELIMITER $$
CREATE TRIGGER `before_delete` BEFORE DELETE ON `temp_assoc_detail` FOR EACH ROW BEGIN 

INSERT INTO `detail_paket`(`id_detail_paket`, `id_paket`, `id_menu`) 
VALUES ('', old.id_assoc, old.id_menu);
